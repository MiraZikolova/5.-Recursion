...
class BallPanelTwo extends JPanel {
	...
	private ArrayList<BallTwo> list = new ArrayList<BallTwo>();    //create an ArrayList of balls
// Create a timer with the initial delay
	...
	protected void paintComponent(Graphics g) {
		...
		for (int i = 0; i < list.size(); i++) {
			BallTwo ball = (BallTwo) list.get(i); // Get a ball  //each and every ball from the list is drawn  //we use get(i) because of the Array List
