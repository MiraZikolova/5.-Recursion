package colectionsDEMO7;

import javax.swing.*;
import java.awt.event.*;
import java.awt.*;

public class BallControlTwo extends JPanel {
	private BallPanelTwo ballPanel = new BallPanelTwo();
	...
	public BallControlTwo() {
		...
		jbtAdd.addActionListener(new Listener());              //difference from BallControlOne
		jbtSubtract.addActionListener(new Listener());         //difference from BallControlOne
